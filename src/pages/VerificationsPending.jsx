...
import { pendingVerifications as seed } from '../data/mockData';
  ...
  return (
    <div className="page-stack">
      ...
      <Modal
        ...
        footer={selected && (
          <>
            <button className="btn btn--outline" onClick={() => resolve(selected.id, 'Rejected')}>Reject</button>
            <button className="btn btn--primary" onClick={() => resolve(selected.id, 'Verified')}>Mark Verified</button>
          </>
        )}
      >
        {selected && (
